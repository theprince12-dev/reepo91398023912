...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('normal_outras', { // Nome EXATO da tabela do modelo
        ...
        outros_79: { type: Sequelize.REAL, allowNull: true },
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('normal_outras');
  }
};